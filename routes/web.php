...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/product/deleteimage/{idImg}/{nombreImg}/{idProd}', [ProductController::class, 'deleteImage'])->name('product.deleteImage');
    ...
    Route::get('/shopping/shoppingproducts/{ced}/{compran}', [ShoppingController::class, 'getProductosComprados']);
